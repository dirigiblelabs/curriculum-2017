...
3. (Optional)You can make corrections to the generated UI for a Launchpad Item, by going to **ScriptingServices**. Choose the package in which the items were created. Open the **extension** folder and there you can find the generated .js files for the Launchpad Items.
