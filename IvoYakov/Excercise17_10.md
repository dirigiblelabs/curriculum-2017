...
Now that you are done you can wirte an SQL Query to your table.<br /> On the top of the screen next to Workspace click on **other** and select **Database Perspective**.<br /> In the **SQL Console** write the following sample SQL Query: &quot;**SELECT \* FROM** _&lt;your\_table\_name&gt;&quot;_
